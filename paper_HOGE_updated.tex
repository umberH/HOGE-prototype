...
These counterfactual explanations are integrated into the LLM narrative via the structured prompt, enabling the generated explanation to include contrastive what-if statements grounded in actual model behaviour rather than LLM speculation. This directly operationalises Miller's contrastive property~\cite{miller2019} within the HOGE framework.
